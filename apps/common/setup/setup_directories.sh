...
export DATABASE_ACCOUNTANT_BACKUPS_DIR=$PERMANENT_DATA_DIR/database/accountant_backups
export DATABASE_BANKS_BACKUPS_DIR=$PERMANENT_DATA_DIR/database/banks_backups
export DATABASE_SMART_HOME_BACKUPS_DIR=$PERMANENT_DATA_DIR/database/smart_home_backups
